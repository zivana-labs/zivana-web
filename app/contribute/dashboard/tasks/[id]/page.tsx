...
function PortalTaskDetailContent() {
  ...
  if (notFound) {
    return (
      <div className="min-h-screen bg-void pt-8 pb-20 px-8 lg:px-12 flex flex-col items-center justify-center">
        <p style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontWeight: 600, fontSize: 22, color: '#E8E6F0', marginBottom: 12 }}>
          Task not available
        </p>
  ...
  if (claimed) {
    return (
      <div className="min-h-screen bg-void pt-8 pb-20 px-8 lg:px-12 flex flex-col items-center justify-center">
        ...
        <p style={{ fontFamily: 'Switzer, sans-serif', fontSize: 14, color: '#7B6FA8', lineHeight: 1.7, marginBottom: 32, textAlign: 'center', maxWidth: 400 }}>
        ...
        <div className="flex gap-3">
          ...
          <Link href="/contribute/dashboard/tasks" className="btn-outline" style={{ fontSize: 13 }}>
            Browse more tasks
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-void pt-8 pb-20">
      <div className="max-w-3xl mx-auto px-8 lg:px-12">
        ...
        <div className="flex items-center gap-3 mb-8">
          ...
          <span style={{ fontFamily: 'Switzer, sans-serif', fontSize: 13, color: '#6B5FA0', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: 200 }}>{task!.title}</span>
        </div>
        ...
        <div className="flex items-center gap-2 flex-wrap mb-5">
          ...
          {task!.primitive && (
            <span style={{ padding: '3px 12px', borderRadius: 20, background: (PRIMITIVE_COLOURS[task!.primitive.toLowerCase()] ?? '#A78BFA') + '15', color: PRIMITIVE_COLOURS[task!.primitive.toLowerCase()] ?? '#A78BFA', border: `1px solid ${PRIMITIVE_COLOURS[task!.primitive.toLowerCase()] ?? '#A78BFA'}30`, fontFamily: 'Switzer, sans-serif', fontSize: 10, fontWeight: 500, letterSpacing: '0.12em', textTransform: 'uppercase' }}>
        ...
        {/* Title */}
        <h1 style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontWeight: 600, fontSize: 'clamp(22px,3vw,36px)', letterSpacing: '-0.02em', lineHeight: 1.2, color: '#E8E6F0', marginBottom: 28 }}>
          {task!.title}
        </h1>

        {/* Meta row */}
        <div className="flex flex-wrap gap-6 p-5 rounded-2xl border mb-8" style={{ background: '#13101E', borderColor: '#1C1730' }}>
          <div className="flex flex-col gap-1">
            ...
            <span style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontWeight: 600, fontSize: 20, color, lineHeight: 1 }}>
          ...
          <div className="flex flex-col gap-1">
            ...
            <span style={{ fontFamily: 'Cabinet Grotesk, sans-serif', fontWeight: 600, fontSize: 20, color: '#E8E6F0', lineHeight: 1 }}>
        ...
        {task!.links && task!.links.length > 0 && (
          <div className="p-5 rounded-2xl border mb-8" style={{ background: '#13101E', borderColor: '#1C1730' }}>
      ...
      <style jsx>{`
        ...
        .task-description > * + * { margin-top: 12px; }
        .task-description p { margin: 0 0 14px; color: #C4B5FD; line-height: 1.8; }
        .task-description h2 {
        ...
        .task-description ul { padding-left: 22px; margin: 8px 0 16px; list-style-type: disc; }
        .task-description ol { padding-left: 22px; margin: 8px 0 16px; list-style-type: decimal; }
        .task-description li { margin-bottom: 8px; color: #C4B5FD; line-height: 1.7; display: list-item; }
        .task-description ul li::marker { color: #A78BFA; }
        .task-description ol li::marker { color: #A78BFA; }
        .task-description strong { color: #E8E6F0; font-weight: 600; }
        .task-description em { color: #C4B5FD; }
        .task-description a { color: #A78BFA; text-decoration: underline; text-underline-offset: 3px; }
        .task-description a:hover { color: #C4B5FD; }
